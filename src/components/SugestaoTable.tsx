      ...
      <Table>
        <TableHeader>
          <TableRow className="bg-slate-900 hover:bg-slate-900">
            ...
            <TableHead className="text-right text-slate-50 font-semibold bg-amber-800">Estoque</TableHead>
            <TableHead className="text-right text-slate-50 font-semibold bg-amber-800">Pendente</TableHead>
            ...
            <TableHead className="text-right text-slate-50 font-semibold bg-amber-800">Pedido</TableHead>
